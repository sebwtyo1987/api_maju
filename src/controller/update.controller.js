...
async function checkUpdate(request, reply) {
  try {
    ...
    const protocol = request.protocol; // http atau https
    const host = request.headers.host; // Mengambil IP beserta Port (misal: 100.91.147.86:3456)
    updateInfo.app_version = updateInfo.app_version;
